...
export const getNearByBusApi = (lat,lng)=>{
    return apiClient.get(`/user/nearby/buses?lat=${lat}&lng=${lng}`);
}

export const getRandomBusesApi = ()=>{
    return apiClient.get('/user/random/buses')
}